...
int main(int argc, char *argv[])
{
  ...
  3a:	83 c3 01             	add    $0x1,%ebx
       set_priority(100-(20+j),pid); // will only matter for PBS, comment it out if not implemented yet (better priorty for more IO intensive jobs)
  3d:	50                   	push   %eax
  3e:	e8 df 03 00 00       	call   422 <set_priority>
  ...
  b8:	e8 45 03 00 00       	call   402 <sleep>
...
printf(int fd, const char *fmt, ...)
{
 ...
 510:	e8 7d fe ff ff       	call   392 <write>
 ...
 571:	e8 1c fe ff ff       	call   392 <write>
 ...
 588:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 58a:	e8 03 fe ff ff       	call   392 <write>
  for(i = 0; fmt[i]; i++){
 ...
 623:	57                   	push   %edi
 624:	53                   	push   %ebx
 625:	e8 68 fd ff ff       	call   392 <write>
        while(*s != 0){
 ...
 677:	e8 16 fd ff ff       	call   392 <write>
        ap++;
