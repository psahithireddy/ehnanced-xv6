   ...
   f:	83 39 03             	cmpl   $0x3,(%ecx)
{
  ...
  30:	68 7b 07 00 00       	push   $0x77b
  35:	6a 01                	push   $0x1
  37:	e8 d4 03 00 00       	call   410 <printf>
    set_priority(*argv[1],*argv[2]);
  3c:	58                   	pop    %eax
  3d:	8b 43 08             	mov    0x8(%ebx),%eax
  40:	5a                   	pop    %edx
  41:	0f be 00             	movsbl (%eax),%eax
  44:	50                   	push   %eax
  45:	8b 43 04             	mov    0x4(%ebx),%eax
  48:	0f be 00             	movsbl (%eax),%eax
  4b:	50                   	push   %eax
  4c:	e8 11 03 00 00       	call   362 <set_priority>
    
    exit();
  51:	e8 5c 02 00 00       	call   2b2 <exit>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
 ...
 379:	85 d2                	test   %edx,%edx
{
 ...
 3a7:	f7 f1                	div    %ecx
 3a9:	0f b6 92 a0 07 00 00 	movzbl 0x7a0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5c4:	e9 8f fe ff ff       	jmp    458 <printf+0x48>
          s = "(null)";
 5c9:	bb 97 07 00 00       	mov    $0x797,%ebx
        while(*s != 0){
